...
if __name__ == "__main__":
    ...
    wires = [
        ...
        Wire(start=(30, 110), stop=(61, 110), current=Current(x=1, y=0), voltage= 0.0001),
        Wire(start=(61, 110), stop=(61, 61), current=Current(x=0, y=-1), voltage= 0.0001),
        Wire(start=(61, 61), stop=(110, 61), current=Current(x=1, y=0), voltage= 0.0001),
        Wire(start=(110, 61), stop=(110, 30), current=Current(x=0, y=-1), voltage= 0.0001),
